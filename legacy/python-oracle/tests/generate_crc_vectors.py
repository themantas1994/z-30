#!/usr/bin/env python3
"""
Regenerates tests/vectors/crc14_vectors.json (at the repository root) from the Python CRC implementation.
...
OUTPUT = os.path.join(os.path.dirname(__file__), "..", "..", "..", "tests", "vectors", "crc14_vectors.json")
