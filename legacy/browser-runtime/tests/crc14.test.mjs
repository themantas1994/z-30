...
const document = JSON.parse(readFileSync(join(here, '..', '..', '..', 'tests', 'vectors', 'crc14_vectors.json'), 'utf8'));
...
{
  const doc = JSON.parse(readFileSync(join(here, '..', '..', '..', 'tests', 'vectors', 'dither_vectors.json'), 'utf8'));
