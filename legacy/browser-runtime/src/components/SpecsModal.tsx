        ...
        <div className="p-4 flex-1 overflow-y-auto text-xs text-[#D4D4D4] space-y-3 leading-relaxed select-text bg-[#0F0F0F]">
          ...
          <div className="space-y-2 bg-[#050505] p-3 border border-[#333]">
            ...
            <ul className="list-disc list-inside space-y-1 text-[#D4D4D4] text-[11px]">
              ...
              <li><strong>Sensitivity - NOT of this receiver:</strong> the {Z30_SPECS.SNR_THRESHOLD_AWGN} dB (50%) / {Z30_SPECS.SNR_THRESHOLD_90_AWGN} dB (90%) AWGN figures were measured, in simulation, on the Python oracle's reference receiver, and z-30 vNext's Rust receiver (decode_slot) measures about the same. <strong>This retired browser receiver does not achieve them:</strong> the 2026-09-24 audit measured its live candidate detector finding 0 of 40 frames at -22 dB and at -18 dB, and its live decode triggering before its audio window existed (C-01/C-02). Neither figure was measured on a real radio. On the ITU-R F.1487 high-latitude moderate channel (3 ms / 10 Hz) z-30 does not decode at any SNR.</li>
