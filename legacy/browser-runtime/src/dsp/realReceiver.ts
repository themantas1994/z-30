...
export interface RealDecodedFrame {
  ...
  apLabel: string;
  /**
   * Set on frames the Experimental self-test synthesised from known symbols, at the configured
   * SNR and frequency, with DT = 0. They are not receptions and must never look like one
   * (audit 2026-09-24, H-03): the decode list labels them SYNTHETIC TEST.
   */
  synthetic?: boolean;
}
